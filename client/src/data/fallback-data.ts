...
export const fallbackProjects: Project[] = [
  ...
  },
  {
    ...
    amenities: ["24/7 Security", "Underground Drainage", "CC Roads", "Parks", "CA Space", "Plantation", "Walking Footpaths", "Underground RCC Drains"],
    features: ["Free Site Visit", "MPA Approved Layout", "24-Acre Gated Community", "Developed in 3 Phases", "Phase 1 & 2: Sold Out", "Phase 3: Now Open - Only 14 Plots", "40-Feet Wide Internal Roads", "45% Open Space with Landscaping and Parks", "Dedicated Park for These 14 Plots", "Adjacent to 800 Acres of Reserved Forest", "Near Malur Industrial Area", "Just 900 meters from STRR (Satellite Town Ring Road)", "Ready-to-Build Plots", "Clear Titles with E-Khata", "Loan Facility Available from Leading Banks", "15 km from Hopefarm", "16 km from ITPL, Whitefield", "Excellent Connectivity to STRR Sarjapur and Hoskote"],
  },
  {
    id: 3,
    name: "TerraGenesis",
    ...
    description: "Set within 2.5 acres of prime land at the heart of a 30+ acre upcoming private township, this exclusive enclave offers just 44 premium villa plots - designed for privacy, space, and a close-knit community. Crafted for discerning buyers, the project features luxury amenities such as landscaped gardens, wide internal roads, a grand entrance, 24/7 security, and modern utility infrastructure. Whether for your dream home or a smart investment, this development blends tranquility with upscale living.",
  ...
  },
  {
    ...
    description: "Get ready for an extraordinary villa project spanning 15 acres in the prestigious Whitefield Extension! This upcoming development promises to redefine luxury living with spacious villa plots designed for discerning homeowners. Located in one of Bangalore's most sought-after corridors, this project will offer the perfect blend of tranquility and connectivity. Stay tuned as we unveil architectural plans, premium amenities, and exclusive pricing that will make this your dream investment destination.",
    imageUrl: "/images/hero-aerial-plots.jpg",
