...
export const fallbackProjects: Project[] = [
  ...
  },
  {
    ...
    features: ["Sold Out", "MPA Approved Layout", "24-Acre Gated Community", "Developed in 3 Phases", "40-Feet Wide Internal Roads", "45% Open Space with Landscaping and Parks", "Adjacent to 800 Acres of Reserved Forest", "Near Malur Industrial Area", "Just 900 meters from STRR (Satellite Town Ring Road)", "Clear Titles with E-Khata", "15 km from Hopefarm", "16 km from ITPL, Whitefield", "Excellent Connectivity to STRR Sarjapur and Hoskote"],
  },
  {
    id: 3,
    name: "TerraGenesis",
